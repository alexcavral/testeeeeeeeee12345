...
module.exports = {
    name: "farm",
	aliases: ["fm", "plantacao", "plantação"],//aliases aqui
...
let aff = client.db.get(`inv/${message.guild.id}/${message.author.id}/alface`)
let aff3 = client.db.get(`inv/${message.guild.id}/${message.author.id}/tomate`)
let aff4 = client.db.get(`inv/${message.guild.id}/${message.author.id}/cenoura`)
let aff5 = client.db.get(`inv/${message.guild.id}/${message.author.id}/batata`)
let aff6 = client.db.get(`inv/${message.guild.id}/${message.author.id}/vacas`)
let aff7 = client.db.get(`inv/${message.guild.id}/${message.author.id}/galinhas`)
...
let fz = db.get(`fazendal1/${message.guild.id}/${user1.id}`)
               ...
               let batata = db.get(`inv/${message.guild.id}/${message.author.id}/batata`)
               if(batata == null) batata = 0;

               let cenoura = db.get(`inv/${message.guild.id}/${message.author.id}/cenoura`)
               if(cenoura == null) cenoura = 0;

               let tomate = db.get(`inv/${message.guild.id}/${message.author.id}/tomate`)
               if(tomate == null) tomate = 0;

               let alface = db.get(`inv/${message.guild.id}/${message.author.id}/alface`)
               if(alface == null) alface = 0;

               let ga = db.get(`inv/${message.guild.id}/${message.author.id}/galinhas`)
               if(ga == null) ga = 0;

               let va = db.get(`inv/${message.guild.id}/${message.author.id}/vacas`)
               if(va == null) va = 0;
        ...
        let author1 = await client.db.get(`antempo/${message.guild.id}/${message.author.id}`); 
            ...
            const aff2 = new MessageEmbed()
               ...
               const plantara = new MessageEmbed()
                .setTitle(`Fazenda de ${message.author.username}`)
               .setDescription(`Sucesso você plantou **todos** os lots!
...
let b = collected
                 if(![collected.user.id].includes(message.author.id)) return message.reply({ content: `**${b.user.tag}**, apenas **${message.author.tag}** pode interagir com esses butões, use esse comando para poder usar os botões.`, ephemeral: true });
                  ...
                  if(b.customId == "Plantar a") {
                    ...
                    client.db.delete(`inv/${message.guild.id}/${message.author.id}/alface`, 4)
                  ...
                  if(b.customId == "Plantar t") {
                    ...
                    client.db.delete(`inv/${message.guild.id}/${message.author.id}/tomate`, 4)
                  ...
                  if(b.customId == "Plantar c") {
                    ...
                    client.db.delete(`inv/${message.guild.id}/${message.author.id}/cenoura`, 4)
                  ...
                  if(b.customId == "Plantar b") {
                    ...
                    client.db.delete(`inv/${message.guild.id}/${message.author.id}/batata`, 4)
                  ...
                  if (b.customId == "vaa") {
                    ...
                    client.db.delete(`inv/${message.guild.id}/${message.author.id}/vacas`, 40)
                  ...
                  if (b.customId == "gaa") {
                    ...
                    client.db.delete(`inv/${message.guild.id}/${message.author.id}/galinhas`, 40)
                    client.db.set(`antempo/${message.guild.id}/${user.id}`, Date.now())
             ...
             .setColor(cor)
                    ...
                    client.db.add(`inv/${message.guild.id}/${user1.id}/planta`, 16)
             ...
             .setColor(cor)
                    ...
                    client.db.add(`inv/${message.guild.id}/${user1.id}/planta`, 16)
                    client.db.add(`inv/${message.guild.id}/${user1.id}/leite`, 20)
                    client.db.add(`inv/${message.guild.id}/${user1.id}/ovos`, 40)
